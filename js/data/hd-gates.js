 ...
 * 
 * 人類圖的閘門排列遵循 Rave Mandala（Ra Uru Hu 系統），
 * 不是易經卦序，而是將 64 卦映射到黃道 360° 的特定位置。
 * 每個閘門佔 360/64 = 5.625°，再分成 6 條爻（每爻 0.9375°）
 * 
 * 起始點：閘門 41 從牡羊座 58.0° 開始（黃道經度 58°）
 * 
 * 排列順序遵照 Human Design Mandala wheel 的正確順序。
 */

/**
 * GATE_SEQUENCE — 黃道上依序排列的 64 閘門
 * 從 58.0° 開始，每個閘門佔 5.625°
 * 這是 Ra Uru Hu 系統的標準 Rave Mandala 順序
 */
...
/** 黃道起始偏移：閘門 41 的起始經度 */
export const MANDALA_START = 58.0;
