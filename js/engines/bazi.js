...
// 六十甲子納音表（按甲子序 0~59 排列，每兩個一組同納音）
const NAYIN_TABLE = [
  "海中金","海中金","爐中火","爐中火","大林木","大林木", // 0~5:  甲子乙丑 丙寅丁卯 戊辰己巳
  "路旁土","路旁土","劍鋒金","劍鋒金","山頭火","山頭火", // 6~11: 庚午辛未 壬申癸酉 甲戌乙亥
  "澗下水","澗下水","城頭土","城頭土","白蠟金","白蠟金", // 12~17:丙子丁丑 戊寅己卯 庚辰辛巳
  "楊柳木","楊柳木","泉中水","泉中水","屋上土","屋上土", // 18~23:壬午癸未 甲申乙酉 丙戌丁亥
  "霹靂火","霹靂火","松柏木","松柏木","長流水","長流水", // 24~29:戊子己丑 庚寅辛卯 壬辰癸巳
  "沙中金","沙中金","山下火","山下火","平地木","平地木", // 30~35:甲午乙未 丙申丁酉 戊戌己亥
  "壁上土","壁上土","金箔金","金箔金","覆燈火","覆燈火", // 36~39:庚子辛丑 壬寅癸卯 甲辰乙巳
  "天河水","天河水","大驛土","大驛土","釵釧金","釵釧金", // 42~47:丙午丁未 戊申己酉 庚戌辛亥
  "桑柘木","桑柘木","大溪水","大溪水","沙中土","沙中土", // 48~53:壬子癸丑 甲寅乙卯 丙辰丁巳
  "天上火","天上火","石榴木","石榴木","大海水","大海水", // 54~59:戊午己未 庚申辛酉 壬戌癸亥
];

function getNayin(stemIdx, branchIdx) {
  // 中國剩餘定理：由 n%10=stemIdx, n%12=branchIdx 解出甲子序 n
  const n = (36 * stemIdx + 25 * branchIdx) % 60;
