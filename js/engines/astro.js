...
import { PLANET_HOUSE_TEXT, PLANET_HOUSE_SHADOW } from '../data/astro-planet-house.js';
import { PLANET_SIGN_SHADOW } from '../data/astro-sign-shadow.js';

/** 使用者年齡（由 calculate 設定，渲染函數共用） */
let userAge = 0;
...
function getComboDetail(p1, p2, type) {
  ...
  const combos = {
    ...
    // ===== 太陽 × 外行星 =====
    '太陽_木星_合': '太陽合木星：你自帶放大鏡效果 — 自信、樂觀、格局大。走到哪裡都有貴人運，機會自己找上門。唯一風險是過度膨脹、答應太多事。學會選擇性地說不，你的好運才能集中在對的地方。',
    '太陽_木星_對沖': '太陽對沖木星：你有野心也有能力，但容易把餅畫太大。答應別人太多、把自己搞得很忙、永遠覺得不夠。你的人生功課是知道「夠了就是夠了」。聚焦比擴張更能帶來成就感。',
    '太陽_木星_四分': '太陽四分木星：你想要更多、更好、更遠。這股不滿足推動你成長，但也可能讓你一直換跑道。關鍵：在一件事上深耕到出成果再往下一站，別每次都差一步就放棄。',
    '太陽_木星_三合': '太陽三合木星：運氣好得不像話的配置。你做事自然有貴人相助、時機也常剛好。這不是躺著就會來 — 你願意嘗試，所以命運願意給你更多。繼續保持開放，回報會超乎預期。',
    '太陽_土星_合': '太陽合土星：你從小就比同齡人成熟，可能覺得人生比較辛苦、什麼都要靠自己。但你是越老越好的人 — 30歲後開始收穫，40歲後進入黃金期。你建立的東西經得起時間考驗。',
    '太陽_土星_對沖': '太陽對沖土星：你常覺得被外界限制 — 主管、制度、家庭責任。但這些壓力其實在幫你打磨實力。關鍵：別把權威當敵人，學會在規則內找到自己的空間，你會成為別人仰賴的支柱。',
    '太陽_土星_四分': '太陽四分土星：你內心有個嚴厲的評審，永遠覺得自己不夠好。這讓你特別努力，但也容易過勞或自我懷疑。學會區分「追求卓越」和「自我虐待」。你已經比自己以為的更好了。',
    '太陽_天王星_合': '太陽合天王星：你就是跟別人不一樣，而且拒絕被塞進任何框架。獨立、前衛、有自己的一套。適合走別人沒走過的路 — 創業、自由業、科技創新。缺點：有時太特立獨行讓人難以親近。',
    '太陽_天王星_對沖': '太陽對沖天王星：你的人生主題是「自由 vs 關係」。想獨立又需要歸屬感，人生常在兩端擺盪。最佳解法：找到能容納你獨特性的關係和環境，而不是非得在自由與歸屬間二選一。',
    '太陽_海王星_合': '太陽合海王星：你有極強的直覺和藝術感受力，能感知到別人感知不到的東西。但你的邊界感弱 — 容易迷失在幻想中、被別人消耗。找到一個創作或靈性出口，把這股感受力變成作品而非內耗。',
    '太陽_海王星_四分': '太陽四分海王星：你對自己是誰有時候很模糊。容易理想化、逃避現實、或把自己投射到別人的期待上。功課：找到一個不靠別人定義的自我認同。創作、靈性修行、療癒工作都能幫你落地。',
    '太陽_冥王星_合': '太陽合冥王星：你身上有一種強烈的存在感 — 安靜的時候也讓人無法忽視。你的人生主題是「死亡與重生」：每隔幾年就會經歷一次大洗牌。每次重生後你都變得更強。關鍵：學會放手，不要死抓不適合的東西。',
    '太陽_冥王星_對沖': '太陽對沖冥王星：你在關係中常遇到權力議題 — 控制、被控制、權力鬥爭。你的功課不是贏過對方，而是學會共享權力。當你不再需要控制結果時，反而會獲得真正的影響力。',
    '太陽_冥王星_四分': '太陽四分冥王星：你內心有一股強大的驅動力，推你不斷自我改造。但有時候這股力量變成自我破壞 — 明知道不好卻停不下來。把這股強迫性的能量導向有意義的目標，你能達到別人做不到的深度。',

    // ===== 月亮 × 外行星 =====
    '月亮_木星_合': '月亮合木星：你的情緒基調是樂觀溫暖的。天生帶給別人舒適感，像一塊磁鐵吸引好緣分。你慷慨大方，但注意別把情緒當信用卡刷 — 過度給予會讓你自己空掉。',
    '月亮_木星_對沖': '月亮對沖木星：你的情緒需求很大 — 需要很多愛、很多關注、很多肯定。這不是缺點，但如果全部向外求會讓你患得患失。學會自己也能滿足自己的情感需求，外面的愛就是錦上添花。',
    '月亮_木星_四分': '月亮四分木星：情緒起伏大，開心的時候嗨到飛、低落的時候很低。你容易用吃東西、購物、過度社交來安撫自己。找到健康的情緒出口：運動、創作、大自然。這些才能真正充電。',
    '月亮_土星_合': '月亮合土星：你從小就學會壓抑情緒。覺得脆弱是不被允許的，哭是沒用的。成年後你很可靠但內心常感到孤獨。療癒之路：允許自己有感覺，跟信任的人說出脆弱。你值得被照顧。',
    '月亮_土星_對沖': '月亮對沖土星：你在關係中容易遇到「冷」的人 — 情感上不太回應你的伴侶或父母。這讓你學會了自給自足，但也讓你不太敢依賴別人。功課：接受溫暖不代表軟弱，被照顧不代表沒用。',
    '月亮_土星_四分': '月亮四分土星：你的情緒表達常被卡住 — 想說卻說不出口，想靠近卻又退回來。你內心的小孩還在等一個安全的環境。建議：從低風險的關係開始練習表達真實感受，慢慢來。',
    '月亮_土星_三合': '月亮三合土星：你的情緒穩定而有紀律。面對壓力時你能保持冷靜，不會被情緒沖走。別人覺得你很成熟、很可靠。適合需要情緒穩定度的角色 — 管理、危機處理、長期照顧工作。',
    '月亮_天王星_合': '月亮合天王星：你的情緒反應很不典型 — 別人覺得該哭的你沒感覺，不重要的事你突然激動。你需要大量的情感自由和獨處空間。適合非傳統的生活模式，別勉強自己當「正常人」。',
    '月亮_天王星_對沖': '月亮對沖天王星：你在「需要穩定」和「需要自由」之間反覆切換。感情穩定了就想跑、單身久了又想定下來。最佳解法：找到一個給你空間的穩定關係，而非在兩極間折騰。',
    '月亮_海王星_合': '月亮合海王星：你的感受力像雷達一樣敏銳，能接收到空間裡的所有情緒訊號。天賦：同理心、藝術、靈性。陷阱：被別人的情緒淹沒、逃避現實、上癮行為。必須學會定期清理能量和設立邊界。',
    '月亮_海王星_對沖': '月亮對沖海王星：你的感受力極強，容易吸收周遭的情緒。有時候分不清哪些感覺是自己的、哪些是別人的。天賦：極強的同理心和藝術感受力。功課：建立清晰的情緒邊界，定期淨化自己的能量場。',
    '月亮_冥王星_合': '月亮合冥王星：你的情感強度是10倍的。愛就愛到底、恨就恨到骨頭裡。你在關係中的佔有慾和控制慾很強。療癒方向：理解你的強烈來自早年的不安全感。當你能信任別人不會離開，就不需要死抓了。',
    '月亮_冥王星_對沖': '月亮對沖冥王星：你在親密關係中容易遇到權力鬥爭 — 操控、情緒勒索、極端的推拉。這是你最深的功課：學會在不控制對方的前提下保持連結。當你放下控制，真正的親密才會進來。',
    '月亮_冥王星_三合': '月亮三合冥王星：你的情感深度超乎常人，能感知到表面之下的暗流。這讓你對人性有深刻的理解。適合心理學、療癒、危機諮商。你的直覺在情感領域特別準，信任它。',

    // ===== 水星 × 外行星 =====
    '水星_木星_合': '水星合木星：你的思考格局大、視野廣。說話有感染力，適合教學、演講、行銷企劃。唯一注意：說太多、承諾太多。把你的大想法落地成可執行的步驟，才不會淪為空談。',
    '水星_木星_對沖': '水星對沖木星：你的想法很多也很雜，什麼都有興趣但不容易深入。跟人溝通時容易發散到天邊回不來。練習：每次討論前設定一個焦點，講完一個再講下一個。深度比廣度更能帶來成就。',
    '水星_土星_合': '水星合土星：你的思考嚴謹、有深度、有紀律。說出來的話有份量，別人會當真。你不會講廢話，但有時候太嚴肅。適合做需要精確和邏輯的工作 — 分析、法律、策略規劃。30歲後溝通能力會越來越被認可。',
    '水星_土星_對沖': '水星對沖土星：你常覺得自己表達不夠好、怕說錯話。跟權威溝通時特別緊張。這個恐懼讓你更謹慎，但也可能讓你錯失發言機會。事實是：你的想法比你以為的更有價值，說出來。',
    '水星_天王星_合': '水星合天王星：你的腦袋跟別人不一樣 — 想法超前、直覺型思考、常有別人沒想到的切入角度。適合科技、創新、研究。缺點是別人可能跟不上你的思路，學會把想法翻譯成大家聽得懂的話。',
    '水星_天王星_對沖': '水星對沖天王星：你的想法常常突然改變，讓別人措手不及。你會被新奇的點子吸引而放棄原本的計劃。優勢：思維彈性極高。要練習的：在執行層面保持一定的穩定度，否則什麼都做一半。',
    '水星_海王星_合': '水星合海王星：你的思考帶有詩意和直覺。擅長用隱喻溝通、感知弦外之音。但邏輯分析不是你的強項 — 數字和細節容易出錯。適合：創意寫作、藝術、心靈工作。搭配一個邏輯型的人合作最佳。',
    '水星_海王星_四分': '水星四分海王星：你常覺得想法很多但說不清楚。腦袋裡很豐富，出口卻模糊。別人可能覺得你在講幹話或說謊（其實你只是表達方式不直接）。練習：先整理好再開口，用具體例子支撐你的抽象感受。',
    '水星_冥王星_合': '水星合冥王星：你的思考力像X光 — 能穿透表面看到本質。你說話有穿透力，別人會覺得被你看透。適合：研究、調查、心理分析、策略。注意：別把這個能力用來操控人，用來幫助人你會更有成就感。',
    '月亮_水星_三合': '月亮三合水星：你的感受和表達自然連結 — 能把情緒清楚地說出來，也能用文字觸動人心。適合寫作、諮商、教學。你的溝通帶有溫度，讓人覺得被理解。',

    // ===== 金星 × 外行星 =====
    '金星_木星_合': '金星合木星：你是天生的幸運兒 — 人緣好、桃花多、品味佳、財運也不差。你喜歡享受生活的美好，也有能力吸引好東西。注意：別太放縱，尤其在花錢和享樂上。「夠了就是夠了」是你的修煉。',
    '金星_木星_三合': '金星三合木星：感情和財運都很順 — 你自然吸引好的關係和資源。你大方、有品味、讓人相處舒服。不需要太努力經營，保持真誠和開放就好。這是最輕鬆的配置之一，享受它。',
    '金星_土星_合': '金星合土星：你對感情和金錢的態度很謹慎 — 不輕易投入、不隨便花錢。年輕時可能覺得愛情很難或自己不夠好。但你是感情裡的長線投資者：一旦投入就非常忠誠，關係越久越穩固。大器晚成型。',
    '金星_土星_對沖': '金星對沖土星：你在感情中容易碰壁 — 覺得不被愛、不被選擇、不夠格。這些經驗讓你更珍惜得到的，但也可能讓你太早妥協或太晚放手。你值得好的感情，但前提是先相信自己值得。',
    '金星_天王星_合': '金星合天王星：你在感情中需要新鮮感和自由。傳統的關係模式可能讓你窒息。你吸引的對象也往往是不太尋常的人。最佳解法：找到一個跟你一樣需要空間的人，而不是試圖把自己塞進傳統框架。',
    '金星_海王星_合': '金星合海王星：你是愛情的理想主義者 — 相信靈魂伴侶、相信完美的愛。你的浪漫程度爆表，藝術品味極佳。陷阱：美化對方、忽視紅旗、在不健康的關係中待太久。學會：真正的愛是接受不完美，不是活在幻想中。',
    '金星_海王星_四分': '金星四分海王星：你在感情中容易搞不清楚狀況 — 對方到底喜不喜歡你？這段關係是真的還是你想像的？你的浪漫濾鏡太強，容易被不可得的人吸引。練習：用事實判斷而非感覺判斷。對方的行為比甜言蜜語重要。',
    '金星_冥王星_合': '金星合冥王星：你在愛情中是全有或全無的人。愛得很深、佔有慾強、很難淡然處之。你吸引的關係往往很激烈 — 很美但也很痛。功課：學會在不控制對方的前提下深愛。放手不等於不愛。',
    '金星_冥王星_對沖': '金星對沖冥王星：你在感情中常經歷權力鬥爭 — 誰愛得多誰就輸了。嫉妒、控制、操控可能是你遇到的課題。療癒方向：願意脆弱不等於失去力量。真正的親密需要雙方都放下盔甲。',
    '金星_冥王星_四分': '金星四分冥王星：你對愛情有強迫性的渴望 — 明知道不好卻放不下。你可能重複吸引有毒的關係模式。轉化之路：把這股強烈的情感能量導向創作、療癒或靈性探索。不是壓抑它，是給它更高層次的出口。',

    // ===== 火星 × 外行星 =====
    '火星_木星_合': '火星合木星：你的行動力和膽量都是超規格的。想到就做、做了就做大。你適合創業、冒險、開拓新市場。風險：太衝動、太自信導致翻車。在出手前花10分鐘想想「最壞情況是什麼」，你的成功率會翻倍。',
    '火星_木星_對沖': '火星對沖木星：你什麼都想做，而且做了就停不下來。精力旺盛但容易過度擴張 — 同時開十個計劃結果一個都沒完成。你需要的不是更多機會，而是更好的篩選。一年專注三件事就好。',
    '火星_土星_合': '火星合土星：行動力搭配紀律 — 你能為目標持續努力很久。不是爆發型而是馬拉松型。適合需要長期堅持的事業。年輕時可能覺得被壓抑，但30歲後你的執行力會超越大部分人。',
    '火星_土星_對沖': '火星對沖土星：你常覺得想做的事被擋住 — 不是時機不對就是有人阻撓。這讓你很挫敗，但也在磨練你的策略能力。學會：不是硬幹就是好的。有時候繞路比衝撞更快到達目的地。',
    '火星_土星_四分': '火星四分土星：你內心有油門和煞車同時踩的感覺。想衝但又怕、想做但又覺得不行。這份內在衝突會讓你在行動和退縮之間反覆。解法：設定小目標，一步一步建立「我可以做到」的信念。',
    '火星_天王星_合': '火星合天王星：你的行動模式「不按牌理出牌」。做事方式跟別人不一樣，有時候突然爆發驚人的能量。適合需要獨創性和快速反應的工作。⚠️ 注意衝動，特別是生氣的時候。把這股爆發力導向創新而非破壞。',
    '火星_海王星_合': '火星合海王星：你的行動力靠靈感驅動 — 有感覺的時候做什麼都行雲流水，沒感覺的時候整個人癱掉。你適合需要創意和直覺的工作，但不適合需要固定節奏的routine。學會在沒靈感時也能做基本功。',
    '火星_海王星_四分': '火星四分海王星：你的精力容易莫名消散 — 明明沒做什麼卻覺得很累。可能有拖延問題或方向不清。根本原因是你在做「不是真正想做的事」。當你找到真正點燃你的目標，精力會突然回來。',
    '火星_冥王星_合': '火星合冥王星：你的意志力是核能等級的。一旦下定決心，天崩地裂都擋不住你。你有能力徹底改造任何東西。但這股力量如果失控會變成毀滅性的憤怒。學會疏導而非壓抑你的火，運動和有目標的拼搏是最好的出口。',
    '火星_冥王星_對沖': '火星對沖冥王星：你在衝突中容易升級到核戰等級。小事變大事、討論變爭吵。你也容易吸引跟你對著幹的人。功課：不是每場仗都要贏。學會選擇戰場，把力量用在值得的事情上。',
    '火星_冥王星_四分': '火星四分冥王星：你內心有一股被壓抑的巨大能量。有時候突然爆發讓自己都嚇到。你可能有自我破壞的傾向 — 明知道不該做卻忍不住。轉化方式：極限運動、深度心理工作、任何讓你在安全環境中釋放強度的活動。',
...
function renderSect(data) {
  ...
  const [sun, moon, mercury, venus, mars, jupiter, saturn] = planets;
  const isDay = sect.isDayChart;
  const HOUSE_TOPICS = ['',
    '自我形象與人生起點', '金錢、自我價值與安全感', '溝通、學習與日常資訊',
    '家庭、根基與內在安全', '戀愛、創造力與快樂', '工作方法、健康與日常秩序',
    '伴侶、合作與一對一關係', '親密、共享資源與深層轉化', '信念、進修與遠方探索',
    '事業、成就與社會角色', '朋友、社群與長期願景', '潛意識、休息與幕後世界'
  ];
  const topic = planet => HOUSE_TOPICS[planet.house] || '人生課題';
  const placement = planet => `${planet.symbol} ${planet.zh}${planet.sign.zh}・第 ${planet.house} 宮`;

  const cards = isDay
    ? [
        ['主導光體', '☉ 太陽', '意志、方向感與「我要成為誰」是整張命盤的主軸。做出能讓自己認同、也能在現實世界留下成果的選擇時，能量最容易整合。'],
        ['同派吉星', '♃ 木星', '成長、機會、貴人與信念較容易用直接的方式出現。但木星不是躺著等好運，而是當你願意擴大視野時，機會更容易接得住。'],
        ['較可控的考驗', '♄ 土星', '責任和限制仍然存在，但較容易轉成紀律、專業與長期成果。越願意建立制度、延遲享受，土星越可能從壓力變成你的靠山。'],
        ['較需留意', '♂ 火星', '急著證明、硬碰硬或過度消耗時，火星的摩擦感會比較突出。先確認戰場值不值得，再出手，通常比一路硬衝更有效。'],
      ]
    : [
        ['主導光體', '☽ 月亮', '情緒、安全感、身體感受與生活節奏是整張命盤的底盤。先安頓感受再做決定，往往不是脆弱，而是你讓判斷恢復準確的方法。'],
        ['同派吉星', '♀ 金星', '關係、美感、愉悅與協調能力較容易自然發揮。你通常不是靠硬搶取得資源，而是靠品味、人情、互惠與讓人願意靠近的氣氛。'],
        ['較可控的考驗', '♂ 火星', '火星在夜盤較容易被導向保護、果斷和危機處理。你可以很有戰力，但最好把力氣用在守界線、解決問題，而不是長期壓抑後一次爆發。'],
        ['較需留意', '♄ 土星', '責任、延遲、孤立感或「只能靠自己」的壓力可能較有重量。刻意求助、拆小步驟並接受事情需要時間，會比獨自硬撐更有用。'],
      ];

  const personalPoints = isDay
    ? [
        ['你的方向盤', placement(sun), `太陽落在「${topic(sun)}」領域。你需要在這裡建立清楚的目標與主導權；當這個領域有進展，你會明顯感到自己活得更像自己。`],
        ['順風與機會', placement(jupiter), `木星會透過「${topic(jupiter)}」放大機會。主動學習、分享、連結資源，通常比被動等待更能啟動這份好運。`],
        ['可累積的實力', placement(saturn), `土星要求你在「${topic(saturn)}」慢慢打底。這裡可能起步較慢，但也是最有機會變成專業、信用與長期成果的地方。`],
        ['避免過度用力', placement(mars), `火星在「${topic(mars)}」容易讓你急著推進或證明自己。遇到摩擦時先設定策略與停損點，力量會更集中。`],
      ]
    : [
        ['你的內在羅盤', placement(moon), `月亮落在「${topic(moon)}」領域。這裡的穩定度會直接影響你的情緒、睡眠與判斷；先照顧這個領域，其他能力才容易正常上線。`],
        ['順風與資源', placement(venus), `金星會透過「${topic(venus)}」帶來好感、合作與享受。善用你的審美和協調力，資源往往在人與人之間流進來。`],
        ['可用的戰力', placement(mars), `火星在「${topic(mars)}」讓你遇到狀況時能迅速反應。清楚說不、保護界線、處理危機，是這股能量較成熟的用法。`],
        ['需要支持的功課', placement(saturn), `土星在「${topic(saturn)}」可能帶來不足感、延遲或沉重責任。不要把求助視為失敗；建立流程、盟友與固定節奏，能顯著降低消耗。`],
      ];

  const mercuryNote = `水星不固定屬於日隊或夜隊，要看它和太陽的相對位置；你本命水星在${mercury.sign.zh}第 ${mercury.house} 宮，思考與溝通方式仍以星座、宮位和相位綜合判讀。`;
  ...
  return `
    <section class="astro-sect astro-sect-${sect.type}">
      ...
      <div class="astro-sect-principle">
        <b>日夜盤到底在看什麼？</b>
        <p>它像是整張星盤的「環境模式」：日盤由太陽領隊，木星與土星較同調；夜盤由月亮領隊，金星與火星較同調。同隊不等於永遠吉利，而是那顆星比較知道怎麼出力；不同隊也不等於壞，只是更需要意識與調節。</p>
      </div>
      <div class="astro-sect-grid">
        ${cards.map(card => `<div class="astro-sect-card"><small>${card[0]}</small><b>${card[1]}</b><p>${card[2]}</p></div>`).join('')}
      </div>

      <div class="astro-sect-personal">
        <h4>🔎 放進你的命盤，實際會怎麼表現</h4>
        <div class="astro-sect-points">
          ${personalPoints.map(point => `
            <div class="astro-sect-point">
              <small>${point[0]}</small>
              <b>${point[1]}</b>
              <p>${point[2]}</p>
            </div>
      ...
      <div class="astro-sect-howto">
        <b>怎麼使用這段解讀：</b>
        <span>先照顧「主導光體」的需求，再主動使用同派吉星；碰到考驗星時，不要只問好不好，而要問「這股力量現在用過頭了，還是還沒學會用？」</span>
      </div>
      <p class="astro-sect-note">${mercuryNote}<br>日夜盤是判斷行星如何發揮的底層條件，仍要和星座、宮位及相位一起看。</p>
    </section>
  `;
}
